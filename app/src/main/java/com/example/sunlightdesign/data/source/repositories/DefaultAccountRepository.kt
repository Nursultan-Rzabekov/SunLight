...
class DefaultAccountRepository constructor(
    ...
    override suspend fun getCountriesList(): CountriesList =
        tasksRemoteDataSource.getCountriesList()

    override suspend fun getUsersList(): UsersList = tasksRemoteDataSource.getUsersList()

    override suspend fun addPartner(addPartner: AddPartner): Login =
        tasksRemoteDataSource.addPartner(addPartner)

    override suspend fun setPackage(package_id: Int, user_id: Int): User =
        tasksRemoteDataSource.setPackage(package_id, user_id)
    ...
    override suspend fun createOrder(createOrderPartner: CreateOrderPartner): AddPartnerResponse =
        tasksRemoteDataSource.createOrder(createOrderPartner)
}
