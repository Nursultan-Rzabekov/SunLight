...
data class AddPartner(val first_name: String,
...
data class CreateOrderPartner(val user_id: Int, val office_id:Int, val order_payment_type: String, val products: Product)
